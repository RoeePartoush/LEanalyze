...
x_cutoff = np.sort(-np.array([[-19,-10],[-11,-2.5],[-4,4],  [0,12]])).tolist()
...
LEplots.match_zoom_wcs(axs,w_s,slitFPdf.iloc[0]['Orig'],slitFPdf.iloc[0]['Length']*0.6,slitFPdf.iloc[0]['Length']*1.0)
