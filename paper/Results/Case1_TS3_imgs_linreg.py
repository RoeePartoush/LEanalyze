...
# -*- coding: utf-8 -*-
"""
Created on Sat Oct 23 13:26:30 2021
...
prev_known_peaks = [14.7,5.5,-0.2,-7.3]#[]
...
for i,(x,y) in enumerate(zip(mjds.flatten()-MJDoffset,peaks.flatten())):
    plt.gca().text(x-15, y-3*np.sign(y), img_titles[i], fontsize=12,verticalalignment='top', bbox=props)
